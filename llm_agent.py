...
def ask_llm(user_text: str, session_id: str = "default") -> str:
    ...
    try:
        ...
        system_prompt = (
            ...
            "═══════════════════════════════════════════════════════\n"
            "ENTRY LOGIC:\n"
            "- You use a Simple Moving Average (SMA20) crossover strategy\n"
            "- LONG signal: Price crosses ABOVE SMA20\n"
            "- SHORT signal: Price crosses BELOW SMA20\n"
            "- No other indicators are implemented yet (no RSI, MACD, volume filters, etc.)\n"
            "- Entry timeframe: Currently running every 60 seconds with latest price data\n\n"
